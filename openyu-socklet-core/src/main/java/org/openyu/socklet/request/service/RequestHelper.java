...
public final class RequestHelper extends BaseHelperSupporter {

	private static final transient Logger LOGGER = LoggerFactory.getLogger(RequestHelper.class);

	private RequestHelper() {
		throw new HelperException(
				new StringBuilder().append(RequestHelper.class.getName()).append(" can not construct").toString());
	}
	...
	public static char[] getCharParameterValues(Request request, String name, int index, char defaultValue) {
	...
	public static boolean[] getBooleanParameterValues(Request request, String name, boolean defaultValue) {
		String[] paramValues = getParameterValues(request, name);
		if (paramValues == null) {
			return null;
		}
	...
	public static double[] getDoubleParameterValues(Request request, String name, double defaultValue) {
		String[] paramValues = getParameterValues(request, name);
		if (paramValues == null) {
			return null;
		}
