...
public class ListenerConfigHelper extends BaseHelperSupporter
{
	private static transient final Logger log = LogManager
			.getLogger(ListenerConfigHelper.class);

	private static ListenerConfigHelper instance;

	public ListenerConfigHelper()
	{}

	public static synchronized ListenerConfigHelper getInstance()
	{
		if (instance == null)
		{
			instance = new ListenerConfigHelper();
		}
		return instance;
	}
