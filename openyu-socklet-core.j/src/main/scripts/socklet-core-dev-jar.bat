...
java -Xmn96m -Xms192m -Xmx192m -Xss128k -XX:PermSize=64m -cp %_CLASSPATH% -XX:+UseParNewGC -Djava.net.preferIPv4Stack=true -verbose:gc -jar ../openyu-socklet-core-1.0.0.DEV.jar %1 %2 %3 %4 %5 %6 %7 %8 %9
