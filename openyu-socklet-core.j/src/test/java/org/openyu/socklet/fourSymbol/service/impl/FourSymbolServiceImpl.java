...
public class FourSymbolServiceImpl extends BaseServiceSupporter implements FourSymbolService {
	...
	private static final long serialVersionUID = -202971108230483781L;

	private static transient final Logger LOGGER = LoggerFactory.getLogger(FourSymbolServiceImpl.class);
	...
	public void sendInitialize(String roleId) {
		...
		Message message = messageService.createMessage(CoreModuleType.FOUR_SYMBOL, CoreModuleType.CLIENT,
				CoreMessageType.FOUR_SYMBOL_INITIALIZE_REPONSE, roleId);
	...
	public void sendPlay(ErrorType errorType, String roleId, List<String> fourSymbolResults) {
		...
		Message message = messageService.createMessage(CoreModuleType.FOUR_SYMBOL, CoreModuleType.CLIENT,
				CoreMessageType.FOUR_SYMBOL_PLAY_RESPONSE, roleId);
	...
	public void sendRewardBoard(String roleId) {
		...
		Message message = messageService.createMessage(CoreModuleType.FOUR_SYMBOL, CoreModuleType.CLIENT,
				CoreMessageType.FOUR_SYMBOL_REWARD_BOARD_REPONSE, roleId);
		//
